...
public class PilotsDistributionTest {
    ...
    public void testLoadCitiesFromDatabase() {
        ...
        List<City> cities = pilotsDistribution.loadCitiesFromDatabase();
...
//
//        Graph graph = pilotsDistribution.buildGraph(flights, cities);
//
//        assertNotNull(graph);
//
...
//    }
    ...
    public void testFindAvailablePilot() {
        ...
        pilots.add(new Employee(1, "Pavel", "Adrian", null, null, null, null, null));
        pilots.add(new Employee(2, "Andries", "Victor", null, null, null, null, null));

        pilots.get(0).setAssignments(3);
        pilots.get(1).setAssignments(5);

        Employee availablePilot = pilotsDistribution.findAvailablePilot(pilots);
    ...
    public void testFindFlightById() {
        ...
        Flight foundFlight = pilotsDistribution.findFlightById(1);
...
//    @Test
//    public void testDistributePilots() {
//        List<Employee> pilots = new ArrayList<>();
...
//
//        //pilotsDistribution.distributePilots(pilots);
//
...
//    }
    ...
    @Test
    public void testVerifyFree_PilotAvailable() {
        List<Employee> pilots = new ArrayList<>();
...
//        assertEquals(pilot2, availablePilots.get(0));
    ...
    @Test
    public void testVerifyFree_PilotNotAvailable() {
        List<Employee> pilots = new ArrayList<>();
        Employee pilot1 = new Employee(1, "Ifimie", "Cerasela", null, null, null, null, null);
...
//        assertTrue(availablePilots.isEmpty());
    ...
    @Test
    public void testFindAvailablePilot_PilotAvailable() {
        List<Employee> pilots = new ArrayList<>();
